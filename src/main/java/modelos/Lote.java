    ...
    public ArrayList<Lote> consulta() {
        ...
        try (Connection con = getCon(); PreparedStatement stm = con.prepareStatement(sql); ResultSet rs = stm.executeQuery()) {
            ...
            while (rs.next()) {
                ...
                String fechaL = rs.getString("fecha_lote");
                String fechaF = rs.getString("fecha_fabricacion");
                String fechaV = rs.getString("fecha_vencimiento");
                int costoL = rs.getInt("costo_lote");
                int c = rs.getInt("cantidad");
                int productoId = rs.getInt("producto_id_producto");
                String nombreP = rs.getString("nombre");

                Lote l = new Lote(id, fechaL, fechaF, fechaV, costoL, c, productoId, nombreP);
                listaLotes.add(l);
            }
